...
The survey covers idiom replacement only: the VUAMC provides no gold paraphrases, and the rubric triad below is well-defined for the figurative-to-literal mapping of idioms but breaks down for conventional metaphors that may require no rewrite at all (Section~\ref{sec:rq3} develops this scoping decision).
