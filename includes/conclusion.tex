...
single-prompt system as a designed control, with all experiments persisted and
reproducible. It adapts the Direct Assessment human-evaluation protocol to
