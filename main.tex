...
\newcommand{\degree}{Máster\ Universitario\ en\ Digital\ Innovation:\ Human\ Computer\ Interaction\ and\ Design}
\newcommand{\tfm}{Master\ Thesis}
\newcommand{\name}{Easy-to-Read (E2R) Adaptation of Figurative Language}
\newcommand{\me}{Jelle\ van\ Lieshout}
\newcommand{\supervisor}{Dr.\ Mari\ Carmen\ Suárez-Figueroa}
...
\usepackage{tikz}               % Vector diagrams (architecture, pipeline, flows)
\usetikzlibrary{arrows.meta, positioning, fit, backgrounds, calc, shapes.geometric}
\input{includes/figstyles}      % Shared diagram palette and node/arrow styles
\usepackage{listings}           % Verbatim system-prompt listings (appendix)
...
\usepackage{longtable}          % Multi-page data tables (appendix)
\usepackage[numbers]{natbib}    % Better bibliography management
\usepackage{bibentry}           % To display bibliography entries inline
...
\title {
	...
	\vspace*{2 cm}
	\large\parbox{0.92\textwidth}{\centering\uppercase{\degree}} \\
	\vspace*{2 cm}
...
\clearpage
\input{includes/rq1_detection}
\clearpage
\input{includes/rq2_decomposition}
\clearpage
\input{includes/rq3_replacement}
\clearpage
